...
public interface Constants {
	...
	/**
	 * Represents the current version of AutoSwitch.
	 */
	public static final String VERSION = "5.6.1";

	/**
	 * Represents the versions of Minecraft this was built for.
	 */
	public static final String SUPPORTED_MC_VERSIONS = "1.9.4 to 1.12.1";

	/**
	 * Represents the versions of Minecraft this should be installed in.
	 */
