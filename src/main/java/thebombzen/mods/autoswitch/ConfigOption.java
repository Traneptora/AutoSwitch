...
public enum ConfigOption implements ThebombzenAPIConfigOption {
	...
	DEFAULT_ENABLED(0, BOOLEAN, "true", "Enabled by default",
			...
			"and on worlds AutoSwitch hasn't", "been used on before."), TOOL_SELECTION_MODE(
			-1, FINITE_STRING, "FAST STANDARD", "Tool Selection Mode",
			"FAST STANDARD picks the best standard tool,",
			"SLOW STANDARD picks the worst standard tool,",
			"FAST NONSTANDARD picks the best tool,",
			"ignoring what's standard."), BLOCKS_SP(-1, BOOLEAN, "true",
			"Use on blocks in SP", "This option determines whether to use",
			"AutoSwitch on blocks in singleplayer."), BLOCKS_MP(-1, BOOLEAN,
			"true", "Use on blocks in MP",
			"This option determines whether to use",
			"AutoSwitch on blocks in multiplayer."), MOBS_SP(-1, BOOLEAN,
			"true", "Use on entities in SP",
			"This option determines whether to use",
			"AutoSwitch on entities in singleplayer."), MOBS_MP(-1, BOOLEAN,
			"true", "Use on entities in MP",
			"This option determines whether to use",
			"AutoSwitch on entities in multiplayer."), TOGGLE_KEY(-1, KEY,
			"F10", "AutoSwitch Toggle Key", "This key toggles AutoSwitch."), PULSE_KEY(
			-1, KEY, "V", "AutoSwitch Pulse Key",
			"This key temporarily toggles", "AutoSwitch while it's held down."), DEBUG(
			-1, BOOLEAN, "false", "Debug Logging", "Log debug output to",
			".minecraft -> mods -> AutoSwitch -> DEBUG.txt"), USE_IN_CREATIVE(
			-1, BOOLEAN, "true", "Use in creative",
